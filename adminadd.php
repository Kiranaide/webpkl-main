...
if (isset($_POST["Simpan"])){
    ...
    $q="INSERT INTO products VALUES('','$judul','$kategori','$deskripsi','$images','$harga') ";
    mysqli_query($conn,$q);
    ...
    <div class="space-y-8 px-8 mx-auto my-auto">
        ...
        <div class="flex items-center justify-center p-12">
            <div class="mx-auto w-full max-w-[550px] font-montserrat">
                <div class="mb-5 font-bold text-4xl">Tambah Produk</div>
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="mb-5">
                        <button class="hover:shadow-form rounded-md bg-almost-white py-3 px-8 text-base font-semibold text-black outline-none"><a href="adminhome.php">Back </a></button>
                    </div>
                    <div class="mb-5">
                        <input type="text" name="judul" id="name" placeholder="Nama Produk" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"/>
                    </div>
                    <div class="mb-5">
                        <input type="text" name="kategori" id="name" placeholder="Harga Produk" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"/>
                    </div>
                    <div class="mb-5">
                        <textarea rows="4" name="deskripsi" id="message" placeholder="Deskripsi Produk" class="w-full resize-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"></textarea>
                    </div>
                    <div class="mb-5">
                        <input type="text" name="harga" id="name" placeholder="Harga Produk" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"/>
                    </div>
                    <div class="mb-5">
                    ...
                    <div>
                        <button type="submit" name="Simpan" class="hover:shadow-form rounded-md bg-almost-black py-3 px-8 text-base font-semibold text-white outline-none">Submit</button>
                    </div>
                </form>
            </div>
        </div>
